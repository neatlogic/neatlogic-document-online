...
采集工具分为基础采集工具和特定类型厂商采集工具，基础采集工具定义公共的OID，各类厂商插件继承公共采集工具可以重载和重写基础采集采集的OID，针对同一个属性采集数据，支持定义多个OID。

<b>说明：</b>
* 此处只枚举一个案例，更多同类工具和使用参见[工具库](../../5.自动化/工具/工具库.md)的工具帮助和说明。
* 网络设备采集和巡检在[资产清单](../../4.巡检/资源中心/资产清单.md)中不同的网络设备资产配置统一用户，如inspect，简化组合工具的入参配置。
> 注意：<br>
...
> ```
> 再到[资产清单](../../4.巡检/资源中心/资产清单.md)对应的网络设备配置好账号，密码需要填入团体字

## 网络设备类组合工具示例
采集工具把采集的数据归档到DB，组合工具的配置详情参考 [组合工具](../../5.自动化/工具/组合工具.md) 文档。
